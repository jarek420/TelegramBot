...
def get_message_cases():
    ...
    if check_file("output_prices_cases.txt"):
        responses = fetch_data(read_file("cases.txt"))
        print(responses)
        save_data_to_file("output_prices_cases.txt", responses)
    else:
        responses = get_data_from_file("output_prices_cases.txt")
        print(responses)
...
def get_message_stockholm_capsules():
    if check_file("output_prices_capsules_stockholm.txt"):
        responses = fetch_data(read_file("stockholm_capsules.txt"))
        print(responses)
        save_data_to_file("output_prices_capsules_stockholm.txt", responses)
    else:
        responses = get_data_from_file("output_prices_capsules_stockholm.txt")
        print(responses)
